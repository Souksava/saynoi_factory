...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light font14">
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="make.php?id=check" class="nav-link">ສິນຄ້າໃກ້ຈະໝົດ</a>
      </li>
    </ul>
    <form action="make.php" id="formsearch" method="POST" class="form-inline ml-3">
          ...
          <div class="table-responsive" style="text-align: center;">
            <table class="table font12" style="width: 1200px">
              ...
              <tr>
                  ...
                  <td>
                      <a href="make2.php?id=<?php echo $row['pro_id'] ?>" class="fa fa-plus toolcolor"></a>&nbsp; &nbsp; 
                  </td>
              </tr>
              <?php
                   }
      ...
      ?>
        <div class="table-responsive" style="text-align: center;">
          <table class="table font12" style="width: 1200px">
            ...
            <?php
                $sql = "select pro_id,pro_name,unit_name,price,qty,qty*price as total,qtyalert,img_path from tbproducts p left join tbunit u on p.unit_id=u.unit_id where qty<qtyalert order by pro_id asc;";
                $result2 = mysqli_query($link, $sql);
                while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
            ?>
            <tr>
