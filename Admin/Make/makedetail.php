<?php
   session_start();
    if($_SESSION['ses_id'] == ''){
      ...
      $id = $_GET['id'];
      $sqlseen = "update tbmaking set seen1='SEEN' where status='ຍັງບໍ່ອະນຸມັດ' and make_no='$id';";
...
<div class="wrapper">
        ...
        <div class="card-body">
            <div style="width: 100%;">
                <div style="width: 48%;float: left;">
                    ...
                    ຜູ້ສັ່ງຜະລິດ: <?php echo $rowget['emp_name'] ?> <br><br><br>
                    <a href="#" class="btn btn-outline-success" data-toggle="modal" data-target="#exampleModalaccept">ອະນຸມັດ</a>
                    <form action="makedetail.php" method="POST" id="formLogout">
                        <div class="modal fade font14" id="exampleModalaccept" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ຢຶນຢັນ</h5>
                                    ...
                                    <div class="modal-body" align="center">
                                        ທ່ານຕ້ອງການອະນຸມັດໃບສັ່ງຜະລິດນ້ຳດື່ມ ຫຼື ບໍ່ ?
                                        <input type="hidden" name="make_no" value="<?php echo $id; ?>">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">ຍົກເລີກ</button>
                                        <button type="submit" name="btnYes" class="btn btn-outline-success">ອະນຸມັດ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div style="width: 48%;float: right;" align="right">
                    ...
                    ສະຖານະ: <?php echo $rowget['status'] ?> <br><br>
                    <a href="#" class="btn btn-outline-danger" data-toggle="modal" data-target="#exampleModalnot">ບໍ່ອະນຸມັດ</a>
                    <form action="makedetail.php" method="POST" method="POST" id="formLogout">
                        <div class="modal fade font14" id="exampleModalnot" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">ຢຶນຢັນ</h5>
                                    ...
                                    <div class="modal-body" align="center">
                                        ທ່ານຕ້ອງການບໍ່ອະນຸມັດໃບສັ່ງຜະລິດນ້ຳດື່ມ ຫຼື ບໍ່ ?
                                        <input type="hidden" name="make_no" value="<?php echo $id; ?>">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">ຍົກເລີກ</button>
                                        <button type="submit" name="btnNot" class="btn btn-outline-danger">ບໍ່ອະນຸມັດ</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="table-responsive" style="text-align: center;">
        <table class="table font12" style="width: 1000px">
          <tr>
              ...
              <th style="width: 120px;">ສິນຄ້າ</th>
              <th style="width: 250px;">ຊື່ສິນຄ້າ</th>
              <th style="width: 150px;">ຈຳນວນຜະລິດ</th>
          </tr>
          <?php
            $no_ = 0;
  ...
  <?php
      if(isset($_POST['btnNot'])){
          ...
          $sqlNo = "update tbmaking set status='ບໍ່ອະນຸມັດ' where make_no ='$make_no';";
          $resultNo = mysqli_query($link,$sqlNo);
          if(!$resultNo){
            echo"<script>";
            echo"window.location.href='accept.php?acceptno=found';";
            echo"</script>";
          }
          else{
            echo"<script>";
            echo"window.location.href='accept.php?acceptno2=success';";
            echo"</script>";
          }
      }
      if(isset($_POST['btnYes'])){
        ...
        $sqlYes = "update tbmaking set status='ອະນຸມັດ' where make_no ='$make_no';";
        $resultYes = mysqli_query($link,$sqlYes);
        if(!$resultYes){
          echo"<script>";
          ...
          $sqlselldetail = "select * from tbmakedetail where make_no='$make_no2';";
          ...
          echo"<script>";
          echo"window.location.href='accept.php?accept2=success';";
          echo"</script>";
        }
      }
