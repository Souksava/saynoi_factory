<?php
   session_start();
    if($_SESSION['ses_id'] == ''){
      ...
      $id = $_GET['id'];
      $sqlseen = "update tbmaking set seen2='SEEN' where status='ອະນຸມັດ' and make_no='$id';";
      $resultseen = mysqli_query($link,$sqlseen);
      $sqlseen2 = "update tbmaking set seen2='SEEN' where status='ບໍ່ອະນຸມັດ' and make_no='$id';";
    ...
    <div class="table-responsive" style="text-align: center;">
      ...
      <div align="right">
             ...
             <div class="col-md-12">
                  ...
                  ?>
                 <br><h4 style="color: #CE3131;"> <?php echo number_format($rowsum['amount']) ?> ລາຍການ</h4> 
             </div>
         </div>
      </div>
    </div>
