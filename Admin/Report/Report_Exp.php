        ...
        while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
            ...
            $output .='
                <tr align="center">
                    ...
                    <td aling="center">'.$row["billno"].'</td>
                    <td align="center">'.$row['dateExp'].'</td>
                    <td align="center">'.$row['timeExp'].'</td>
...
$content = '
            ...
            <div style="text-align: center;">
                <h2>
                    <u>
                        ລາຍງານຂໍ້ມູນການສົ່ງອອກນ້ຳດື່ມ<br>
                    </u>
                </h2>
            </div>
            <table width="100%" border="1" cellspacing="0" cellpadding="3" style="font-size: 8px;">
                <tr align="center" style="background-color: #dbdbd8">
                    ...
                    <th style="width: 120px;">ລູກຄ້າ</th>
