  ...
  <div class="main-footer font14">
    ...
    <div style="width: 100%;">
        <div style="width: 48%; float: left;">
            <b>ລາຍງານການຜະລິດ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
        </div>
        <div style="width: 48%; float: right;" align="right">
            <form action="Report_M.php" method="POST" id="formReport" target="_blank">
              <?php
                    if(isset($_POST['btnSearch'])){
                      $date_1 = $_POST['date1'];
                      $date_2 = $_POST['date2'];
                      $stat_us = $_POST['status'];
                ?>
                <input type="hidden" name="status" value="<?php echo $stat_us ?>" class="form-control">
    ...
    <div class="col-md-8">
      <form action="report_make.php" id="form1" method="POST">
          <div class="input-group">        
              ...
              <div class="input-group-prepend">
                  ...
                  <button type="submit" name="btnAll" class="btn btn-outline-warning">ລາຍການທັງໝົດ</button>
              </div>
          </div>
      </form>
    </div><br>
    ...
    <div class="table-responsive" style="text-align: center;">
        <table class="table font12" style="width: 1200px">
          ...
          <tr>
              ...
              <td>
                  <a href="report_make2.php?id=<?php echo $row['make_no']; ?>" class="fa fa-info toolcolor"></a>&nbsp; &nbsp; 
              </td>
          </tr>
            <?php
              }
