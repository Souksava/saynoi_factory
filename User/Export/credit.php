      ...
      ?>
        ...
        <div class="info">
          <a href="#" class="d-block"><?php echo $_SESSION['emp_name'] ?></a>
            ...
            <div class="main-footer font14">
              ...
              <div style="width: 100%;">
                  <div style="width: 48%; float: left;">
                      <b>ຊ່ຳລະບິນຄ້າງຈ່າຍ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
                  </div><br><br>
                  <div class="col-md-8">
                    <form action="credit.php" id="form1" method="POST">
              ...
              <div class="table-responsive" style="text-align: center;">
                  <table class="table font12" style="width: 1200px">
                    ...
                    <?php
                        $no_ = 0;
                        $sql = "select billno,dateExp,timeExp,amount,cus_name,emp_name,x.status from tbexports x left join tbemployees e on x.emp_id=e.emp_id left join tbcustomers c on x.cus_id=c.cus_id where billno='$billno' or dateExp between '$date1' and '$date2';";
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="creditdetail.php?id=<?php echo $row['billno'] ?>" class="fa fa-info toolcolor"></a>&nbsp; &nbsp; 
                        </td>
                    </tr>
                    <?php
                        }
            ...
            <br>
            <?php
                if(isset($_GET['pay'])=='found'){
                  echo'<script type="text/javascript">
                  swal("", "ບໍ່ສາມາດຊ່ຳລະບິນຄ້າງຈ່າຍໄດ້ ກະລຸນາລອງໃໝ່ອີກຄັ້ງ !!", "error");
                  </script>';
                }
                if(isset($_GET['pay2'])=='success'){
                  echo'<script type="text/javascript">
                  swal("", "ຊ່ຳລະບິນຄ້າງຈ່າຍສຳເລັດ !!", "success");
                  </script>';
                }
            ?>
