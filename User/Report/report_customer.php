...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light font14">
    ...
    <form action="report_customer.php" method="POST" id="formsearch" class="form-inline ml-3">
  ...
  <div class="main-footer font14">
    ...
    <div style="width: 100%;">
        <div style="width: 48%; float: left;">
            <b>ລາຍງານຂໍ້ມູນລູກຄ້າ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
        </div>
        <div style="width: 48%; float: right;" align="right">
            <form action="Report_cus.php" method="POST" id="form1" target="_blank">
              <?php
    ...
    <div class="table-responsive">
        <table class="table font12" style="width: 1200px;">
            ...
            <?php
                $Search = $_POST['Search'];
                $s =  '%'.$Search.'%';
                $sql2 = "select * from tbcustomers where cus_id like '$s' or cus_name like '$s' or cus_surname like '$s' or gender like '$s' or email like '$s' order by cus_id asc;";
