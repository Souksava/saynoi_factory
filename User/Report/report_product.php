...
<head>
  ...
  <title>ລາຍງານຂໍ້ມູນນ້ຳດື່ມ</title>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light font14">
    ...
    <form action="report_product.php" method="POST" id="formsearch" class="form-inline ml-3">
  ...
  <div class="main-footer font14">
    ...
    <div style="width: 100%;">
        <div style="width: 48%; float: left;">
            <b>ລາຍງານຂໍ້ມູນນ້ຳດື່ມ</b>&nbsp <img src="../../icon/hidemenu.ico" width="10px">
        </div>
        <div style="width: 48%; float: right;" align="right">
            <form action="Report_Pro.php" method="POST" id="frmReport" target="_blank">
                <?php
    ...
    <div class="table-responsive">
        <table class="table font12" style="width: 1200px;">
            ...
            <?php
                $Search = $_POST['Search'];
                $s =  '%'.$Search.'%';
                $sql2 = "select pro_id,pro_name,unit_name,price,qty,qtyalert,img_path,qty*price as total from tbproducts p left join tbunit u on p.unit_id=u.unit_id where pro_id like '$s' or pro_name like '$s' or unit_name like '$s' order by pro_id asc;";
            ...
            <tr>  
                ...
                <td><?php echo number_format($row['total'],2) ?> ກີບ</td>
